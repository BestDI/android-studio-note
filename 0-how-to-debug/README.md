...
|![](./image/btn_step_over.png)|Step Over|单步执行，可以简单理解为“执行到下一行代码”
...
![](./image/test_condition_break_point_1.png) ![](./image/test_condition_break_point_2.png)  
...
* 代码片段求值  
![](./image/test_evaluate_code_fragment.png)  
